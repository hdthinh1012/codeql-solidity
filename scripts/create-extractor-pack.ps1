...
Copy-Item codeql-extractor.yml, ql\lib\solidity.dbscheme extractor-pack #  ql\lib\solidity.dbscheme.stats will be copy from a solidity database after running codeql database
